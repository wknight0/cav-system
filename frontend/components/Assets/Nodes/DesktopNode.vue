<template>
    <BaseNode :data="data" :icon="data.isHighlighted ? highlightedDesktopIcon : desktopIcon" :showHandles="showHandles">
        ...
        <!-- Antivirus status property -->
        <div class="form-group radio-group">
            <div class="radio-row">
                <label for="antivirusStatus">Antivirus Status:</label>
                <div class="radio-buttons">
                    <label v-for="option in antivirusOptions" :key="option.value">
                        <RadioButton 
                            :value="option.value" 
                            v-model="data.properties.antivirus_status" 
                        />
                        {{ option.label }}
                    </label>
                </div>
...
<script setup>
    ...
    import desktopIcon from '../../../assets/icons/wiredclient.svg';
    import highlightedDesktopIcon from '../../../assets/highlightedIcons/wiredclient-highlight.svg';
