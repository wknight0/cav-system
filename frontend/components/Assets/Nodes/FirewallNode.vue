<template>
    <BaseNode :data="data" :icon="data.isHighlighted ? highlightedFirewallIcon : firewallIcon" :showHandles="showHandles">
        ...
        <!-- VPN support property -->
        <div class="form-group radio-group">
            <div class="radio-row">
                <label for="vpnSupportOptions">VPN Support:</label>
                <div class="radio-buttons">
                    <label v-for="option in vpnSupportOptions" :key="option.value" >
                        <RadioButton 
                            :value="option.value" 
                            v-model="data.properties.vpn_support" 
                        />
                        {{ option.label }}
                    </label>
                </div>
...
<script setup>
    ...
    import highlightedFirewallIcon from '../../../assets/highlightedIcons/firewall-highlight.svg';
